...
export const services: Service[] = [
  {
    ...
    features: [
      ...
      'Test and balance <a href="https://www.cdc.gov/healthy-swimming/about/index.html" target="_blank" rel="noopener noreferrer">water chemistry</a>, chemicals included',
      'Clean and inspect the <a href="https://en.wikipedia.org/wiki/Sand_filter" target="_blank" rel="noopener noreferrer">pool filter</a>',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      '<a href="https://www.energystar.gov/products/pool_pumps" target="_blank" rel="noopener noreferrer">Pump, motor</a>, and filter repair or replacement',
      '<a href="https://www.energy.gov/energysaver/swimming-pool-heating" target="_blank" rel="noopener noreferrer">Pool heater</a> diagnosis and repair (refer to our affiliated business partner)',
      "Plumbing and valve repair",
      "Equipment troubleshooting and part replacement",
      'Green pool recovery and <a href="https://en.wikipedia.org/wiki/Algae" target="_blank" rel="noopener noreferrer">algae</a> cleanup',
    ],
